...
function MovieDetail() {
  ...
  // Hàm để lưu vị trí video hiện tại và thông tin phim vào lịch sử
  const savePlaybackPosition = useCallback(() => {
    const video = videoRef.current;
    if (video && currentEpisode && movie) {
  ...
  }, [currentEpisode, getPlaybackPositionKey, movie, episodes, selectedServer]);
